...
#to avoid dialog box when firefox crash: https://leonax.net/p/7/disable-application-error-dialog/
#

#selenum python api: http://selenium-python.readthedocs.io/api.html
